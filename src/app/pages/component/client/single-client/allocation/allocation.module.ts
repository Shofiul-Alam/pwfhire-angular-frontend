...
const routes: Routes = [{
	...
	data: {
      title: 'Single Client',
      urls: [{title: 'Client',url: '/clients'},{title: 'Project',url: '/single-client'},{title: 'Order',url: '/single-client-project'},{title: 'Task',url: '/single-client-order'},{title: 'Allocations'}]
    },
...
export class SingleClientAllocationModule {
